...
module Alloc_mode = struct
  ...
  let is_local = function Heap -> false | Local -> true | External -> false

  let is_heap = function Heap -> true | Local -> false | External -> false

  let is_external = function Heap -> false | Local -> false | External -> true
end
